...
################################################################################
load("...\\tdModel_transitionModel_ALL_16062019.RData") # TODO: adapt paths before use
load("...\\indField_transitionModel_ALL_16062019.RData")
...
seQ <- trunc(seq(from=1, to=5000, length=1500))

# Wave 2
ps2 <- 1-median(pii.1)
p2 <- 1-median(pim.1)
pw2 <- ps2*p2
ppd.2  <- (1-pii.1)[seQ]*(1-pim.1)
ddW2 <- density(ppd.2)
...
ppd.3 <- (1-pii.1)[seQ]*(1-pim.1)*(1-pii.2)[seQ]*(1-pim.2) + (1-pii.1)[seQ]*(pim.1)*(1-pii.2)[seQ]*(1-pim.2)
ddW3 <- density(ppd.3)
...
ppd.4 <- (1-pii.1)[seQ]*(1-pim.1)*(1-pii.2)[seQ]*(1-pim.2)*(1-pii.3)[seQ]*(1-pim.3) + 
  (1-pii.1)[seQ]*(pim.1)*(1-pii.2)[seQ]*(1-pim.2)*(1-pii.3)[seQ]*(1-pim.3) +
  (1-pii.1)[seQ]*(1-pim.1)*(1-pii.2)[seQ]*(pim.2)*(1-pii.3)[seQ]*(1-pim.3)  
ddW4 <- density(ppd.4)
...
ppd.5 <- (1-pii.1)[seQ]*(1-pim.1)*(1-pii.2)[seQ]*(1-pim.2)*(1-pii.3)[seQ]*(1-pim.3)*(1-pii.4)[seQ]*(1-pim.4) + 
  (1-pii.1)[seQ]*(pim.1)*(1-pii.2)[seQ]*(1-pim.2)*(1-pii.3)[seQ]*(1-pim.3)*(1-pii.4)[seQ]*(1-pim.4) +
  (1-pii.1)[seQ]*(1-pim.1)*(1-pii.2)[seQ]*(pim.2)*(1-pii.3)[seQ]*(1-pim.3)*(1-pii.4)[seQ]*(1-pim.4) +  
  (1-pii.1)[seQ]*(1-pim.1)*(1-pii.2)[seQ]*(1-pim.2)*(1-pii.3)[seQ]*(pim.3)*(1-pii.4)[seQ]*(1-pim.4) +  
  (1-pii.1)[seQ]*(pim.1)*(1-pii.2)[seQ]*(1-pim.2)*(1-pii.3)[seQ]*(pim.3)*(1-pii.4)[seQ]*(1-pim.4)  
ddW5 <- density(ppd.5)
